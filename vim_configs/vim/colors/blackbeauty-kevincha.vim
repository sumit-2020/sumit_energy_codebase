...
hi LineNr		  term=underline  cterm=bold  ctermfg=yellow	guibg=brown guifg=white
hi Question		  term=standout  cterm=bold  ctermfg=darkgreen	gui=bold  guifg=Green
hi StatusLine	  term=bold,reverse  cterm=bold ctermfg=black ctermbg=white gui=bold guibg=white guifg=brown

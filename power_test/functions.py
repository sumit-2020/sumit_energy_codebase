...
def run_binary(i, dimm, test_name, bank=0, row=0, pattern=0x00, num_ops=0, is_sandbox=False):
...
def get_measurements(meter, is_sandbox=False) :
  values = []
